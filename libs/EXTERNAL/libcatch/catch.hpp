...
#if (defined _MSC_VER && _MSC_VER >= 1300) || (defined __GNUC__ && (__GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ >= 3))) || (defined __clang__ && __clang_major__ >= 3)
...
class JunitReporter : public CumulativeReporterBase {
    ...
    void writeSection(std::string const& className,
        ...
        for (SectionNode::ChildSections::const_iterator
                 it
             = sectionNode.childSections.begin(),
