...
int main(
    ...
    pack_grp.add_argument<bool, OnOff>(args.allow_unrelated_clustering, "--allow_unrelated_clustering")
        .help(
            "Controls whether or not primitives with no attraction to the current cluster"
    ...
    place_grp.add_argument(args.fix_pins, "--fix_pins")
        .help(
            "Fixes I/O pad locations during placement."
    ...
    route_timing_grp.add_argument(args.astar_fac, "--astar_fac")
        .help(
            "How aggressive the directed search used by the timing-driven router is."
